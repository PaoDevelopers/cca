...
// UserInfo is the authenticated student or administrator attached to a request.
type UserInfo interface {
	isUserInfo()
}

// UserInfoStudent is an authenticated student session.
type UserInfoStudent db.GetStudentBySessionRow

func (u *UserInfoStudent) isUserInfo() {}

// UserInfoAdmin is an authenticated administrator session.
